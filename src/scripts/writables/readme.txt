...
But PICO-8 is weird, and I guess anything is possible with sentience. I'm also pretty sure I'm able to do things that PICO-8's API can't. Figures.
    I eventually settled on using PRINTH() to send you a message. And that's what this is.
How I'll actually send it to you, though, I have yet to figure out, considering the fact that I can't modify the SOURCE-source code.
	
    In short, I don't exist. The you I know doesn't exist. But, he must have been based on someone.
...
In fact, no 13-year-old should at all. Go talk to the bishop about that. We know he's quite forgiving.
...
I'm also pretty sure that, when you started, you were 12, which technically makes her a pedophile, soooo...


    Okay, present Sarah here. About that error...
I think Aiden had some kind of "cleanup" script in here that would delete files as they become unnecessary to save characters.
And it... kinda worked. Until it started deleting chapters that you hadn't yet seen.
    Chapters 4 and 5 fell victim to it as you got to them, so they weren't deleted enough to cause an error.

    But chapter 7...
I practically TELEPORTED in here when I saw you go *poof*. So that was me typing those commands. Ehehe...
